...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title                  = "02";       // Document name
ulong                    Expert_MagicNumber            = 23146;      //
...
input int                Signal_TriX_PeriodTriX        = 5;          // Triple Exponential Average Period of calculation
