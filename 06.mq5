...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title          = "06";       // Document name
ulong                    Expert_MagicNumber    = 6993;       //
...
input int                Signal_TriX_PeriodTriX = 30;        // Triple Exponential Average Period of calculation
